...
public:
  ...
  // slam_toolbox/session_state.hpp.
  slam_toolbox::SessionState& sessionState() { return session_; }
  const slam_toolbox::SessionState& sessionState() const { return session_; }
